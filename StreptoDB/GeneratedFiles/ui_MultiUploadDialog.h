...
public:
    ...
    void setupUi(QDialog *multiUpload)
    {
        ...
        QPalette palette;
        QBrush brush(QColor(255, 148, 150, 255));
        ...
        line_internID->setPalette(palette);
        ...
        QPalette palette1;
        QBrush brush2(QColor(255, 180, 181, 255));
        ...
        line_scale_2->setPalette(palette2);
        ...
        line_scale_3->setPalette(palette3);
        ...
        line_scale_4->setPalette(palette4);
